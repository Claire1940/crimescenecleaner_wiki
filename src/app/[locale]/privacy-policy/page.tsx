...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Crime Scene Cleaner Wiki',
    description: 'Crime Scene Cleaner Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Crime Scene Cleaner Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Crime Scene Cleaner Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Crime Scene Cleaner Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam) or the developers of Crime Scene Cleaner. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@crimescenecleaner.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@crimescenecleaner.wiki</a>
            </p>
            <p>
