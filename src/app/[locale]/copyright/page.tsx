...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Crime Scene Cleaner Wiki',
    description: 'Copyright and intellectual property information for Crime Scene Cleaner Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Crime Scene Cleaner Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Crime Scene Cleaner Wiki',
      description: 'Copyright and intellectual property information for Crime Scene Cleaner Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Crime Scene Cleaner Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Crime Scene Cleaner Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Crime Scene Cleaner Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Crime Scene Cleaner Developers</strong> - Creators of the Crime Scene Cleaner game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Crime Scene Cleaner</strong> - Trademark of the game developers</li>
              <li><strong>Crime Scene Cleaner Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Crime Scene Cleaner Wiki.
            </p>
            ...
            <p>
              ...
              Crime Scene Cleaner Wiki<br />
              Email: <a href="mailto:dmca@crimescenecleaner.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@crimescenecleaner.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Crime Scene Cleaner Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Crime Scene Cleaner Wiki (crimescenecleaner.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@crimescenecleaner.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@crimescenecleaner.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@crimescenecleaner.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@crimescenecleaner.wiki</a>
            </p>
            <p>
